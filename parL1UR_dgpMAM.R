...
dgpMAM_modelANN_l1_UR <- clusterApplyLB(cl, 1:runs, function(x) final.compile(dgp = "MAM", nobs = c(28, 420), freq = 7, model = "ANN", 
                                                                              h = 7, origin = 5, type.loss = "l1", 
                                                                              tuning = c(0.1), weighted = FALSE))
dgpMAM_modelAAN_l1_UR <- clusterApplyLB(cl, 1:runs, function(x) final.compile(dgp = "MAM", nobs = c(28, 420), freq = 7, model = "AAN", 
                                                                              h = 7, origin = 5, type.loss = "l1", 
                                                                              tuning = c(0.1), weighted = FALSE))
dgpMAM_modelANA_l1_UR <- clusterApplyLB(cl, 1:runs, function(x) final.compile(dgp = "MAM", nobs = c(28, 420), freq = 7, model = "ANA", 
                                                                              h = 7, origin = 5, type.loss = "l1", 
                                                                              tuning = c(0.1), weighted = FALSE))
dgpMAM_modelAAA_l1_UR <- clusterApplyLB(cl, 1:runs, function(x) final.compile(dgp = "MAM", nobs = c(28, 420), freq = 7, model = "AAA", 
                                                                              h = 7, origin = 5, type.loss = "l1", 
                                                                              tuning = c(0.1), weighted = FALSE))
dgpMAM_modelAAdA_l1_UR <- clusterApplyLB(cl, 1:runs, function(x) final.compile(dgp = "MAM", nobs = c(28, 420), freq = 7, model = "AAdA", 
                                                                              h = 7, origin = 5, type.loss = "l1", 
                                                                              tuning = c(0.1), weighted = FALSE))
dgpMAM_modelAAdN_l1_UR <- clusterApplyLB(cl, 1:runs, function(x) final.compile(dgp = "MAM", nobs = c(28, 420), freq = 7, model = "AAdN", 
                                                                              h = 7, origin = 5, type.loss = "l1", 
                                                                              tuning = c(0.1), weighted = FALSE))
dgpMAM_modelMAM_l1_UR <- clusterApplyLB(cl, 1:runs, function(x) final.compile(dgp = "MAM", nobs = c(28, 420), freq = 7, model = "MAM", 
                                                                              h = 7, origin = 5, type.loss = "l1", 
                                                                              tuning = c(0.1), weighted = FALSE))
