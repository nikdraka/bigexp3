...
save(list = c("dgpMAM_modelANN_l2_WR", "dgpMAM_modelAAN_l2_WR", "dgpMAM_modelANA_l2_WR", "dgpMAM_modelAAA_l2_WR",
              "dgpMAM_modelAAdA_l2_WR", "dgpMAM_modelAAdN_l2_WR", "dgpMAM_modelMAM_l2_WR"),
     file = "L2_WR_dgpMAM.Rdata")
