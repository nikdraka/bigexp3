...
# Install smooth package from github
...
save(list = c("dgpANN_modelANN_l2_UR", "dgpANN_modelAAN_l2_UR", "dgpANN_modelANA_l2_UR", "dgpANN_modelAAA_l2_UR", 
              "dgpANN_modelAAdA_l2_UR", "dgpANN_modelAAdN_l2_UR", "dgpANN_modelMAM_l2_UR"),
     file = "testHEC.Rdata")